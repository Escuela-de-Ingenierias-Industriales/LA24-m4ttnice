 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Oct 10 20:18:53 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                Encoder_Handler_ESP32
...
extern void Encoder_Handler_ESP32_Outputs_wrapper(int32_T *pos,
  const real_T *xD);
extern void Encoder_Handler_ESP32_Update_wrapper(int32_T *pos,
  real_T *xD);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  Encoder_Handler_ESP32_Outputs_wrapper(pos, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  Encoder_Handler_ESP32_Update_wrapper(pos, xD);
}
