 ...
 *
 */
void Encoder_Handler_ESP32_Outputs_wrapper(int32_T *pos,
			const real_T *xD)
{
 ...
 *
 */
void Encoder_Handler_ESP32_Update_wrapper(int32_T *pos,
			real_T *xD)
{
...
if (xD[0]!=1) {
    ...
    //Left Encoder
        ...
        Enc[0].pinA=27;      /* set pin A1               */
        Enc[0].pinB=26;      /* set pin B1              */
    //Right Encoder
        Enc[1].pinA=25;      /* set pin A2               */
        Enc[1].pinB=33;      /* set pin B2              */
