 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Oct 10 20:40:28 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                dummy_Test
...
extern void dummy_Test_Outputs_wrapper(int32_T *pos,
  const real_T *xD);
extern void dummy_Test_Update_wrapper(int32_T *pos,
  real_T *xD);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  dummy_Test_Outputs_wrapper(pos, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  dummy_Test_Update_wrapper(pos, xD);
}
